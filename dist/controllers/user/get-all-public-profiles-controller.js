...
exports.getAllUsersPublicProfile = void 0;
...
exports.getAllUsersPublicProfile = (0, async_handler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.status(http_status_codes_1.StatusCodes.OK).json(new api_response_handler_1.ApiResponse(http_status_codes_1.StatusCodes.OK, publicData, user_types_1.PUBLIC_PROFILE_GET_SUCCESS));
}));
